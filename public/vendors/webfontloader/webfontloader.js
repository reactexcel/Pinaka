...
/* Web Font Loader v1.6.27 - (c) Adobe Systems, Google. License: Apache 2.0 */(function () {
  function aa(a, b, c) {
    ...
    if (!a) throw Error();if (arguments.length > 2) {
    ...
    p = Function.prototype.bind && Function.prototype.bind.toString().indexOf('native code') != -1 ? aa : ba;return p.apply(undefined, arguments);
  ...
  function z(a) {
    if (typeof a.f === 'string') return a.f;var b = a.m.location.protocol;b == 'about:' && (b = a.a.location.protocol);return b == 'https:' ? 'https:' : 'http:';
  }function ea(a) {
  ...
  function B(a, b, c, d) {
    var e = a.c.getElementsByTagName('head')[0];if (e) {
      var f = t(a, 'script', { src: b }),
        ...
        g || this.readyState && this.readyState != 'loaded' && this.readyState != 'complete' || (g = !0, c && c(null), f.onload = f.onreadystatechange = null, f.parentNode.tagName == 'HEAD' && e.removeChild(f));
    ...
    var b = [];a = a.split(/,\s*/);for (var c = 0; c < a.length; c++) {
      var d = a[c].replace(/['"]/g, '');d.indexOf(' ') != -1 || /^\d/.test(d) ? b.push('\'' + d + '\'') : b.push(d);
    }return b.join(',');
  }function K(a) {
    return a.a + a.f;
  }function I(a) {
    var b = 'normal';a.a === 'o' ? b = 'oblique' : a.a === 'i' && (b = 'italic');return b;
  }
  function ga(a) {
    var b = 4,
        c = 'n',
    ...
    this.v = a;this.B = b;this.c = c;this.a = d;this.s = g || 'BESbswy';this.f = {};this.w = e || 3E3;this.u = f || null;this.o = this.j = this.h = this.g = null;this.g = new N(this.c, this.s);this.h = new N(this.c, this.s);this.j = new N(this.c, this.s);this.o = new N(this.c, this.s);a = new H(this.a.c + ',serif', K(this.a));a = P(a);this.g.a.style.cssText = a;a = new H(this.a.c + ',sans-serif', K(this.a));a = P(a);this.h.a.style.cssText = a;a = new H('serif', K(this.a));a = P(a);this.j.a.style.cssText = a;a = new H('sans-serif', K(this.a));a = P(a);this.o.a.style.cssText = a;O(this.g);O(this.h);O(this.j);O(this.o);
      ...
      T = null;function U() {
    if (T === null) {
      var a = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent);T = !!a && (parseInt(a[1], 10) < 536 || parseInt(a[1], 10) === 536 && parseInt(a[2], 10) <= 11);
    }return T;
  ...
  function ma(a, b, c) {
    ...
    var b = a.g.a.offsetWidth,
        c = a.h.a.offsetWidth,
        d = void 0;(d = b === a.f.serif && c === a.f['sans-serif']) || (d = U() && ma(a, b, c));d ? q() - a.A >= a.w ? U() && ma(a, b, c) && (a.u === null || a.u.hasOwnProperty(a.a.c)) ? V(a, a.v) : V(a, a.B) : na(a) : V(a, a.v);
  }function na(a) {
  ...
  W.prototype.h = function (a) {
    ...
    --a.f == 0 && a.j && (a.o ? (a = a.a, a.g && w(a.f, [a.a.c('wf', 'active')], [a.a.c('wf', 'loading'), a.a.c('wf', 'inactive')]), L(a, 'active')) : M(a.a));
  }function pa(a) {
  ...
  function ra(a, b, c, d, e) {
    var f = --a.h == 0;(a.f || a.g) && setTimeout(function () {
      var a = e || null,
        ...
        b.f += c.length;f && (b.j = f);var h = void 0,
  ...
  sa.prototype.load = function (a) {
    function b() {
      if (f['__mti_fntLst' + d]) {
        var _c = f['__mti_fntLst' + d](),
            _e = [],
            h = void 0;if (_c) for (var m = 0; m < _c.length; m++) {
          var l = _c[m].fontfamily;void 0 != _c[m].fontStyle && void 0 != _c[m].fontWeight ? (h = _c[m].fontStyle + _c[m].fontWeight, _e.push(new H(l, h))) : _e.push(new H(l));
        }a(_e);
    ...
    for (var c = b.length, d = 0; d < c; d++) {
      var e = b[d].split(':');e.length == 3 && a.f.push(e.pop());var f = '';e.length == 2 && e[1] != '' && (f = ':');a.a.push(e.join(f));
    }
  }
  function za(a) {
    if (a.a.length == 0) throw Error('No fonts to load!');if (a.c.indexOf('kit=') != -1) return a.c;for (var b = a.a.length, c = [], d = 0; d < b; d++) {
      c.push(a.a[d].replace(/ /g, '+'));
    }b = a.c + '?family=' + c.join('%7C');a.f.length > 0 && (b += '&subset=' + a.f.join(','));a.g.length > 0 && (b += '&text=' + encodeURIComponent(a.g));return b;
  }function Aa(a) {
  ...
  function Fa(a) {
    for (var b = a.f.length, c = 0; c < b; c++) {
      var d = a.f[c].split(':'),
        ...
        }g.length > 0 && (f = g);d.length == 3 && (d = d[2], g = [], d = d ? d.split(',') : g, d.length > 0 && (d = Ba[d[0]]) && (a.c[e] = d));
    ...
    return new Ga(b, a);
  };var Z = { load: p(Y.load, Y) };typeof define === 'function' && define.amd ? define(function () {
    return Z;
